...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">停车场管理</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 <li><a href="<%=basePath %>UserInfo/frontlist">用户</a></li>
                  <li><a href="<%=basePath %>CarModel/frontlist">车型</a></li>
                  <li><a href="<%=basePath %>SpaceOrder/frontlist">车位预约</a></li>
                  -->
                  
                <li><a href="<%=basePath %>Region/frontlist">区域</a></li>
                <li><a href="<%=basePath %>SpaceInfo/frontlist">停车位</a></li>
                <li><a href="<%=basePath %>Car/frontlist">车辆查询</a></li> 
                <li><a href="<%=basePath %>Park/frontlist">车辆停车</a></li>
