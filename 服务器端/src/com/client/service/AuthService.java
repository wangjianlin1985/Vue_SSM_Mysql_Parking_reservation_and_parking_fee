...
public class AuthService {
	...
	public boolean setUserToken(String authToken, UserToken userToken) {
		//设置用户Token有效时间1年
		Cache.put(authToken, userToken, 60 * 60 * 24 * 365 * 1000);
	 ...
	 * @return
	 */ 
	public void removeUserToken(String authToken) { 
	...
	public boolean setTelCode(String tel, String code) {
		//设置用户Token有效时间
		String CODE_KEY = tel + "_CODE";
		Cache.put(CODE_KEY, code, 10 * 2 * 1000);
		return Cache.get(CODE_KEY) != null; 
	}
