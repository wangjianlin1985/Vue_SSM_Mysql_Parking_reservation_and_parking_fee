...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>CarModel/carModel_frontAdd.jsp" style="display:none;">添加车型</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<carModelList.size();i++) {
					    	            		...
					    	            		CarModel carModel = carModelList.get(i); //获取到车型对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=carModel.getModelId() %></td>
 											<td><%=carModel.getModelName() %></td>
 											<td>
 												<a href="<%=basePath  %>CarModel/<%=carModel.getModelId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="carModelEdit('<%=carModel.getModelId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="carModelDelete('<%=carModel.getModelId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div style="display:none;">
		...
		<form name="carModelQueryForm" id="carModelQueryForm" action="<%=basePath %>CarModel/frontlist" class="mar_t15" method="post">
