		       ...
		       text: "区域车位管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Region/region_add.jsp"
			    	   	},
			    		{
			    	   		text: "区域管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Region/region_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加停车位",
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SpaceInfo/spaceInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "停车位管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SpaceInfo/spaceInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "车辆停车管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Park/park_add.jsp"
			    	   	},
			    		{
			    	   		text: "车辆停车管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Park/park_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "车辆及预约管理",
			       ...
			       children:
			    	   [{
			    	    ...
			    	    },
			    	    {
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SpaceOrder/spaceOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "车位预约管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SpaceOrder/spaceOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻留言管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "CarModel/carModel_add.jsp"
			    	   	},
			    		{
			    	   		text: "车型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CarModel/carModel_query_result.jsp"
			    	    },
			    	    {
			    		    text: "修改密码",
			    		    state: "open",
