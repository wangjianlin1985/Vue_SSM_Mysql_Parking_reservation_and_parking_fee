    ...
    <div id="userInfo">
        ...
        <scroll class="content" top="1" bottom="50" ref="scroll" style="padding: 0px 5px">
            <van-form @submit="onSubmit">
                ...
                <van-field v-show="false" autosize clearable name="userInfo.password" v-model="password" label="登录密码：" placeholder="请输入登录密码" :rules="[{ required: true, message: '请填写登录密码' }]" />
...
<script>
    ...
    export default {
        ...
        created() {
            //this.user_name = this.$route.params.user_name;  //接收用户名参数
